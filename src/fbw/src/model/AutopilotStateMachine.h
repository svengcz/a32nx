...
class AutopilotStateMachineModelClass
{
 public:
  ...
  struct D_Work_AutopilotStateMachine_T {
    ...
    real_T newFcuAltitudeSelected_p;
    ...
    boolean_T newFcuAltitudeSelected_e;
    boolean_T sTCAS;
    boolean_T latch;
    boolean_T sSRS;
    ...
    boolean_T eventTime_not_empty_ob;
    ...
    rtDW_LagFilter_AutopilotStateMachine_T sf_LagFilter_g;
    rtDW_WashoutFilter_AutopilotStateMachine_T sf_WashoutFilter_i;
  ...
  struct Parameters_AutopilotStateMachine_T {
    ...
    real_T RateLimiterDynamicVariableTs_InitialCondition_l;
    real_T RateLimiterDynamicVariableTs_InitialCondition_j;
    real_T RateLimiterDynamicVariableTs_InitialCondition_b;
    real_T RateLimiterDynamicVariableTs_InitialCondition_ji;
    real_T RateLimiterDynamicVariableTs_InitialCondition_jy;
    real_T RateLimiterDynamicVariableTs_InitialCondition_bk;
    real_T RateLimiterDynamicVariableTs_InitialCondition_c;
    ...
    real_T CompareToConstant_const_k1;
    ...
    real_T Falling_Value_e;
    real_T Raising_Value_e;
    real_T Falling_Value_l;
    real_T Raising_Value_k;
    real_T Falling_Value_i;
    real_T Raising_Value_i;
    real_T Falling_Value_l1;
    real_T Raising_Value_g;
    real_T Falling_Value_f;
    real_T Raising_Value_f;
    real_T Falling_Value_c;
    real_T Raising_Value_h;
    real_T Falling_Value_m;
  };
 ...
 private:
  ...
  void AutopilotStateMachine_OFF_entry_b(void);
  ...
  void AutopilotStateMachine_ROLL_OUT_entry_k(void);
  ...
  void AutopilotStateMachine_ON_c(void);
